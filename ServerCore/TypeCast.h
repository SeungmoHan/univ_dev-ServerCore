...
To TypeCast(From* ptr)
{
	...
	if (TypeConversion<TL>::CanConvert(ptr->GetType(), IndexOf<TL, remove_pointer_t<To>>::value))
...
bool CanCast(From* ptr)
{
	if (ptr == nullptr)
		return false;
	using TL = typename From::TL;
	return TypeConversion<TL>::CanConvert(ptr->GetType(), IndexOf<TL, remove_pointer_t<To>>::value);
}
