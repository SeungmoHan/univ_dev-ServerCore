...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Protocol::Player, objectid_),
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\002\022\017\n\007victims\030\003 \003(\004\"R\n\006Player\022\020\n\010objec"
  "tId\030\001 \001(\004\022\014\n\004name\030\002 \001(\t\022(\n\nplayerType\030\003 "
  "\001(\0162\024.Protocol.PlayerTypeb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Struct_2eproto = {
  false, false, 193, descriptor_table_protodef_Struct_2eproto, "Struct.proto", 
...
Player::Player(const Player& from)
  ...
  ::memcpy(&objectid_, &from.objectid_,
    ...
    reinterpret_cast<char*>(&objectid_)) + sizeof(playertype_));
...
void Player::InternalSwap(Player* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Player, objectid_)>(
